classdef SonnetProject  <  handle
    ...
    %   Author: Bashir Souid
    %
    %   Updated By: Robert Roach, Ethan Ferguson
    %
    %   Version Number: 8.0
    %
    %   Version Notes:
    ...
    %       Matlab 7.10.0 (R2010a), Matlab 7.12.0 (2011a), and Matlab 9.6.0 (R2019a). This interface 
    %       has been tested on Windows XP 32-bit, Windows Vista 32-bit, 
    %       Windows Vista 64-bit, Windows 7 64-bit, and Windows 10 64-bit.
    %
    ...
    properties
        VersionOfSonnet         % This indicates the version of the Sonnet project editor as a double.
        VersionOfSonnetString   % This indicates the version of the Sonnet project editor as found in the file.
        ...
        FocusedSweepSet         % The most recently accessed sweep set, defaults to 1
    ...
    methods
        ...
        function obj = SonnetProject(aFilename)
            ...
            elseif nargin == 1
                ...
                aPartialPath='';
                %TODO abstract filoe path splitting
                while aRemainingPath ~= "" %CHANGED (aRemainingPath not stored as matrix, isempty did not function
                ...
                if contains(aFtypTagLine,'Netlist')
                ...
                if (strcmp(aTempString,'VER')==1)   % if it is VER then we need to read the version number
                    ...
                    obj.VersionOfSonnetString = strtrim(aVersionOfSonnet);
                    aVersionOfSonnet=regexp(aVersionOfSonnet, '(\d+\.\d+)', 'tokens');
                    aVersionOfSonnet=str2double(aVersionOfSonnet{1});
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                if aVersionOfSonnet<12
                    disp(['This script is only intended for Sonnet versions 12 and up.' ...
                ...
                while(1==1)
                    ...
                    switch aTempString
                        ...
                        case 'OPT'
                            ...
                            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                            if aVersionOfSonnet < 17
                                aOptimizationBlock = SonnetOptimizationBlockOld(aFid);
                        ...
                        case 'VARSWP'
                            ...
                            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                            if aVersionOfSonnet < 17
                                aVariableSweepBlock = SonnetVariableSweepBlockOld(aFid);
                        ...
                        otherwise
                            ...
                            % consistency.
                            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                            disp(['Unknown block "' aTempString '"'])
                ...
                obj.Filename=char(aFilename);
                obj.FilePath=char(aFilePath);
                ...
                if aVersionOfSonnet < 17
                    ...
                    obj.FrequencyBlock=aVariableSweepBlock;
                end
        ...
        function initialize(obj)
            ...
            obj.VersionOfSonnet=17.00;
            obj.VersionOfSonnetString='17.0';
        ...
        function initializeNetlist(obj)
            ...
            % Specify the default Ftyp string
            obj.VersionOfSonnet=12.52;
            obj.VersionOfSonnetString='12.52';
            obj.isValidProjectVersion=true;
        ...
        function aNewProject=clone(obj)
            ...
            if obj.isValidProjectVersion
                ...
                aNewProject.VersionOfSonnetString=obj.VersionOfSonnetString;
        ...
        function save(obj)
            ...
            if obj.isValidProjectVersion	% If the project was indicated to be valid then we write out the project. Otherwise dont write it out.
                ...
                if isempty(obj.Filename)
                    ...
                    aFid = fopen(strcat(obj.FilePath,obj.Filename), 'w');
                    %CHANGED : [obj.FilePath obj.Filename] was not a valid
                    %file identifier
                end
                ...
                if obj.isGeometryProject()
                    ...
                    elseif floor(aVersion) == 16
                        fprintf(aFid, 'FTYP SONPROJ 16 ! Sonnet Project File\n');
                    elseif floor(aVersion) == 17
                        fprintf(aFid, 'FTYP SONPROJ 17 ! Sonnet Project File\n');
                    else
                    ...
                    elseif floor(aVersion) == 16
                        fprintf(aFid, 'FTYP SONNETPRJ 16 ! Sonnet Project File\n');
                    elseif floor(aVersion) == 17
                        fprintf(aFid, 'FTYP SONNETPRJ 17 ! Sonnet Project File\n');
                    else
                        error('Unknown version');
                    end
                end
                ...
                if ~(exist(strcat(obj.FilePath,'.',filesep,'sondata',filesep,strrep(obj.Filename,'.son','')),'dir')==7) % If the directory does not exist
                    mkdir(strcat(obj.FilePath,'.',filesep,'sondata',filesep,strrep(obj.Filename,'.son','')));
                end
        ...
        function saveAs(obj, theFilename, isClean)
            ...
            if ~isa(theFilename,'string') && ~isa(theFilename,'char')
        ...
        function aSignature=stringSignature(obj)
            ...
            if obj.isValidProjectVersion
                ...
                if obj.isGeometryProject()
                    ...
                    elseif floor(aVersion) == 13
                        aSignature = sprintf('FTYP SONPROJ 10 ! Sonnet Project File\n');
                    elseif floor(aVersion) == 14
                        aSignature = sprintf('FTYP SONPROJ 12 ! Sonnet Project File\n');
                    elseif floor(aVersion) == 15
                        aSignature = sprintf('FTYP SONPROJ 13 ! Sonnet Project File\n');
                    elseif floor(aVersion) == 16
                        aSignature = sprintf('FTYP SONPROJ 16 ! Sonnet Project File\n');
                    elseif floor(aVersion) == 17
                        aSignature = sprintf('FTYP SONPROJ 17 ! Sonnet Project File\n');
                    else
                        error('Unknown version');
                    end
                else
                    ...
                    elseif floor(aVersion) == 13
                        aSignature = sprintf('FTYP SONNETPRJ 10 ! Sonnet Netlist Project File\n');
                    elseif floor(aVersion) == 14
                        aSignature = sprintf('FTYP SONNETPRJ 12 ! Sonnet Netlist Project File\n');
                    elseif floor(aVersion) == 16
                        aSignature = sprintf('FTYP SONNETPRJ 16 ! Sonnet Project File\n');
                    elseif floor(aVersion) == 17
                        aSignature = sprintf('FTYP SONNETPRJ 17 ! Sonnet Project File\n');
                    else
                        error('Unknown version');
                    end
                end
        ...
        function FigNum=draw3d(obj,FigNum)
            ...
            %
            %   Note: This method is only for geometry projects.
            %   Note: This method provides the same functionality
        ...
        function [aStatus, aMessage]=simulate(obj,theOptions)
            ...
            %   [aStatus aMessage]=Project.simulate() saves the project and calls
            %   Sonnet em to simulate the Sonnet Project File. If the simulation
            %   is successful then 'aStatus' will be true; otherwise it
            %   will be false. Error messages returned from em will
            %   be stored in 'aMessage'.
            %
            %   [aStatus aMessage]=Project.simulate(Options) saves the project and
            %   calls Sonnet em to simulate the project with some particular options
            %   as defined below. If the simulation is successful then 'aStatus' will
            %   be true; otherwise it will be false. Error messages returned from em
            %   will be stored in 'aMessage'.
            %
            ...
            if nargin == 1 % We didnt receive options
                ...
                % Call EM to simulate
                [aStatus, aMessage]=SonnetCallEm([obj.FilePath obj.Filename],theOptions, wait);
        ...
        function [aNumberOfMegaBytesOfMemory,aNumberOfSubsections]=...
            ...
            [~, aStringLocation]=regexp(anOutputString,'subsections .* and');
            aNumberOfMegaBytesOfMemory=sscanf(anOutputString(aStringLocation+1:length(anOutputString)),'%f',1);
        ...
        function cleanProject(obj)
            ...
            % results
            if exist(strcat(obj.FilePath,'.',filesep,'sondata',filesep,strrep(obj.Filename,'.son','')),'dir')==7
                rmdir(strcat(obj.FilePath,'.',filesep,'sondata',filesep,strrep(obj.Filename,'.son','')),'s');
                mkdir(strcat(obj.FilePath,'.',filesep,'sondata',filesep,strrep(obj.Filename,'.son','')));
            end
            ...
            if ~isempty(obj.FileOutBlock)
                for iCounter=1:length(obj.FileOutBlock.ArrayOfFileOutputConfigurations)
                    ...
                    if ~isempty(dir(aResponseName)) % delete the response file
                        disp(strcat('Deleting: ', aResponseName));
                        system(strcat('del ', aResponseName));
                    end
                end
            end
        end
        ...
        function index = addSweepSet(obj, enabled)
            %addSweepSet   Adds a sweep set to the project
            %   Only works with Sonnet Project versions >= 17
            %       (Only v >= 17 have sets of sweeps)
            %   returns the index of the new sweep set, which can be
            %       retrieved by SonnetProject.getSweepSet(index)
            %   enabled will default to 'Y'. Valid values are 'Y' 'N' 0 or 1
            if nargin == 1
                enabled = 'Y';
            end
            index = obj.VariableSweepBlock.addSweepSet(enabled);
            obj.focus(length(obj.VariableSweepBlock.ArrayOfSweepSets));
        end
        
        
        function aSweepSet = getSweepSet(obj, index)
            %getSweepSet   Gets a sweep set from the project by index
            %returns focused sweep if no index is given, defaulting to 1
            %   Only works with Sonnet Project versions >= 17
            %       (Only v >= 17 have sets of sweeps)
            %   returns the sweep set (a SonnetSweepSetBlock)
            if nargin == 1
                index = obj.FocusedSweepSet;
            end
            obj.focus(index);
            aSweepSet = obj.VariableSweepBlock.getSweepSet(index);
        end
        
        function aSweep = getSweep(obj, sweep_index)
            %getSweepSet   Gets a sweep from the project at last indexed sweep set
            %   Only works with Sonnet Project versions >= 17
            %       (Only v >= 17 have sets of sweeps)
            %   returns the sweep
            aSweep = obj.VariableSweepBlock.getSweepSet(obj.focus()).getSweep(sweep_index);
        end
        
        function aSweep = getSweepFromSet(obj, set_index, sweep_index)
            %getSweepSet   Gets a sweep from the project by set index and sweep index
            %   Only works with Sonnet Project versions >= 17
            %       (Only v >= 17 have sets of sweeps)
            %   returns the sweep
            aSweep = obj.VariableSweepBlock.getSweepSet(set_index).getSweep(sweep_index);
        end
        
        function aSweep = getVariableSweep(obj, sweep_index)
            %getSweepSet   Gets a variable sweep from the project by sweep
            %index from focused sweep set
            %   Only works with Sonnet Project versions >= 17
            %       (Only v >= 17 have sets of sweeps)
            %   returns the sweep
            aSweep = obj.VariableSweepBlock.getSweepSet(obj.focus).getVariableSweep(sweep_index);
        end
        
        function aSweep = getVariableSweepFromSet(obj, set_index, sweep_index)
            %getSweepSet   Gets a variable sweep from the project by set index and sweep index
            %   Only works with Sonnet Project versions >= 17
            %       (Only v >= 17 have sets of sweeps)
            %   returns the sweep
            aSweep = obj.VariableSweepBlock.getSweepSet(set_index).getVariableSweep(sweep_index);
        end
        
        function index = addSweep(obj, sweep)
            %addSweepToSet   Adds a frequency or variable sweep to the project
            %with the set of the specified index (as seen in Project.VariableSweepBlock.ArrayOfSweepSets)
            %returns the index of the sweep in the set
            %   <sweep> can either be a sweep constructed with CreateSweep,
            %   or sweep constructed with CreateVariableSweep,
            if nargin < 2
                error('Too few arguments')
            end
            if ~isa(sweep, 'SonnetFrequency') && ~isa(sweep, 'SonnetVariableSweep')
                error(['`sweep` Must be a sweep, is a ' class(sweep)])
            end
            
            index = obj.getSweepSet(obj.focus()).addSweep(sweep);
        end
        
        function index = addSweepToSet(obj, set_index, sweep, enabled, adaptive, arg1, arg2, arg3)
            %addSweepToSet   Adds a frequency or variable sweep to the project
            %with the set of the specified index (as seen in Project.VariableSweepBlock.ArrayOfSweepSets)
            %returns the index of the sweep in the set
            %   <sweep> can either be a sweep constructed with CreateSweep,
            %   a sweep constructed with CreateVariableSweep,
            %   or the type of sweep ('SWEEP', 'ABS_ENTRY', 'DC', 'ESWEEP', 'LIST', 'STEP')
            %   Project.addSweepToSet(set_index, sweep, enabled, adaptive, ...) adds a frequency sweep
            %   to the specified set. addFrequencySweep requires a string specifying the type
            ...
            switch nargin
                ...
                case 3
                    ...
                    index = obj.getSweepSet(set_index).addSweep(sweep);
                case 6
                    index = obj.getSweepSet(set_index).addSweep(type, enabled, adaptive, arg1);
                case 7
                    index = obj.getSweepSet(set_index).addSweep(type, enabled, adaptive, arg1, arg2);
                case 8
                    index = obj.getSweepSet(set_index).addSweep(type, enabled, adaptive, arg1, arg2, arg3);
            end
        end
        
        function index = lastSweepSetIndex(obj)
            %lastSweepSetIndex   Returns the index of the last sweep
            %indexed with getSweepSet or created with addSweepSet
            if obj.VersionOfSonnet < 17
                error("Sweep sets do not exist in v<17, no sweep set index can be returned")
            end
            index = obj.FocusedSweepSet;
        end
        
        function index = focusedSweepSet(obj)
            %focusedSweepSet   Returns the index of the last sweep
            %indexed with getSweepSet or created with addSweepSet
            if obj.VersionOfSonnet < 17
                error("Sweep sets do not exist in v<17, no sweep set index can be returned")
            end
        ...
        function index_out = focus(obj, index)
            %focus()   Returns the index of the last sweep indexed with getSweepSet or created with addSweepSet
            %focus(index) sets the focus to the index specified
            if obj.VersionOfSonnet < 17
                error("Sweep sets do not exist in v<17, no sweep set index can be returned")
            end
            if length(obj.VariableSweepBlock.ArrayOfSweepSets) == 0
                index_out = 0;
                return;
            end
            if nargin == 1
                index_out = obj.FocusedSweepSet;
            elseif index <= length(obj.VariableSweepBlock.ArrayOfSweepSets)
                obj.FocusedSweepSet = index;
                index_out = obj.FocusedSweepSet;
            else
                error("Cannot focus on index %d, index exceeds number of sweeps (%d)", index, length(obj.VariableSweepBlock.ArrayOfSweepSets))
            end
        end
        ...
        function addFrequencySweep(obj,theSweepType,theargument1,theargument2,theargument3)
            ...
            %   the sweep.
            %
            %   For v17+ it will add to the most recent sweep set,
            %   defaulting to 1 if none have been accessed yet.
            %   Enabled defaults to 'Y', adaptive to 'N' 
            %       (adaptive to 'Y' if the sweep is ABS)
            %
            %   Types and arguments are as follows:
            %
            %       SWEEP       StartFrequency,EndFrequency,StepFrequency
            ...
            if obj.VersionOfSonnet < 17
                ...
                switch nargin
                    case 3
                        obj.getSweepSet().addSweep(theSweepType, 'Y', 'default', theargument1);
                    case 4
                        obj.getSweepSet().addSweep(theSweepType, 'Y', 'default', theargument1,theargument2);
                    case 5
                        obj.getSweepSet().addSweep(theSweepType, 'Y', 'default', theargument1,theargument2,theargument3);
                end
            end
        end
        ...
        function addSweepFrequencySweep(obj,theStartFrequency,theEndFrequency,theStepFrequency)
            ...
            if obj.VersionOfSonnet<17
                ...
                obj.addFrequencySweep('SWEEP', theStartFrequency, theEndFrequency, theStepFrequency);
            end
        ...
        function addAbsFrequencySweep(obj,theStartFrequency,theEndFrequency)
            ...
            if obj.VersionOfSonnet<17
                ...
                obj.addFrequencySweep('ABS_ENTRY', theStartFrequency, theEndFrequency);
            end
        end
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function addAbsEntryFrequencySweep(obj,theStartFrequency,theEndFrequency, target)
            ...
            if obj.VersionOfSonnet<17
                ...
                obj.addFrequencySweep('ABS_ENTRY', theStartFrequency, theEndFrequency, target);
            end
        ...
        function addAbsFmaxFrequencySweep(obj,theStartFrequency,theEndFrequency,theMaximum)
            ...
            % See also SonnetProject.addFrequencySweep
            if obj.VersionOfSonnet >= 17
                error("addAbsFmaxFrequencySweep is deprecated for sonnet projects v17+")
            end
            if isempty(obj.FrequencyBlock)
                obj.FrequencyBlock=SonnetFrequencyBlock();
                isThereAFrequencyBlock=false;
        ...
        function addAbsFminFrequencySweep(obj,theStartFrequency,theEndFrequency,theMinimum)
            ...
            % See also SonnetProject.addFrequencySweep
            if obj.VersionOfSonnet >= 17
                error("addAbsFminFrequencySweep is deprecated for sonnet projects v17+")
            end
        ...
        function addDcFrequencySweep(obj,theMode,theFrequency)
            ...
            if obj.VersionOfSonnet<17
                ...
                if nargin == 3
                    obj.addFrequencySweep('DC_FREQ', theMode, theFrequency);
                else
                    obj.addFrequencySweep('DC_FREQ', theMode);
                end
            end
        end
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function addEsweepFrequencySweep(obj,theStartFrequency,theEndFrequency,theFrequencyCount)
            ...
            if obj.VersionOfSonnet<17
                ...
                obj.FrequencyBlock.addEsweep(theStartFrequency,theEndFrequency,theFrequencyCount);
                obj.changeSelectedFrequencySweep('STD');
            else
                obj.addFrequencySweep('ESWEEP',theStartFrequency,theEndFrequency,theFrequencyCount);
            end
        end
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function addLsweepFrequencySweep(obj,theStartFrequency,theEndFrequency,theFrequencyCount)
            ...
            if obj.VersionOfSonnet<17
                ...
                obj.FrequencyBlock.addLsweep(theStartFrequency,theEndFrequency,theFrequencyCount);
                obj.changeSelectedFrequencySweep('STD');
            else
                obj.addFrequencySweep('LSWEEP',theStartFrequency,theEndFrequency,theFrequencyCount);
            end
        end
        ...
        function addStepFrequencySweep(obj,theStepFrequency)
            ...
            if obj.VersionOfSonnet<17
                ...
                obj.addFrequencySweep('STEP',theStepFrequency);
            end
        end
        ...
        function changeSelectedFrequencySweep(obj,theStringForSelectedFrequencySweep)
            ...
            if obj.VersionOfSonnet >= 17
                error("Enable/disable individual sweeps and sweep sets with their enable() and disable() methods for v17+ instead of selecting a single sweep to run.")
            end
            if isempty(obj.FrequencyBlock)
                obj.FrequencyBlock=SonnetFrequencyBlock();
                isThereAFrequencyBlock=false;
        ...
        function [aFrequencySweepObject, aIndexInFrequencySweepArray]=...
            ...
            %Invalid for v17+
            if obj.VersionOfSonnet >= 17
                error("Enable/disable individual sweeps and sweep sets with their enable() and disable() methods for v17+.")
            end
            if isempty(obj.FrequencyBlock)
                obj.FrequencyBlock=SonnetFrequencyBlock();
                isThereAFrequencyBlock=false;
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function index = addVariableSweep(obj,theSweepHandle)
            %addVariableSweepSimple   Add a variable sweep
            %   Project.addVariableSweep(theSweepHandle) will add a variable sweep
            %   to the array of sweep entries. The specified frequency sweep will
            %   be used for the parameter sweep.
            %   returns the index of the sweep in sweep set for v17++, in
            %       CellArrayOfBlocks for v16--
            %   For v17+ adds to the focused sweep set (see SonnetProject.focus())
            %       Use SonnetProject.getSweepSet(n).addVarialbeSweep to
            %       add to sweep set with index n
            %
            ...
            %
            %   Example usage v17+:
            %       % Create a sensitivity variable sweep object
            %       % with variable named 'variable_name', enabled,
            %       % starting at frequency of 4.5 and ending at 5.5
            %       aSweep=CreateVariableSweep('variable_name', 'sensitivity', 'Y', [4.5, 5.5]);
            %
            %       % Add the variable sweep to the project
            ...
            if obj.VersionOfSonnet < 17
                ...
                if isempty(obj.VariableSweepBlock)
                    ...
                    index = length(obj.CellArrayOfBlocks);
                else
                    isBlockExists=false;
                    for iCounter=1:length(obj.CellArrayOfBlocks)
                ...
                obj.VariableSweepBlock.ArrayOfSweeps{1,locationInBlock}.Sweep = theSweepHandle;
            else
                index = obj.getSweepSet.addVariableSweep(theSweepHandle);
            end
        end
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function index = addVariableSweepParameter(obj,theParameterName,theMinValue,theMaxValue,theNumberOfPoints,theEntryIndex)
            ...
            %       5) Sweep Index (Optional) -- The index for the sweep
            %              set block this parameter should be added to.
            %              Default is the focused sweep set. (1 for v16-)
            %
            ...
            if obj.VersionOfSonnet < 17
                ...
                index = length(obj.VariableSweepBlock.ArrayOfSweeps{theEntryIndex}.ParameterArray{end+1});
            else
                index = obj.getSweepSet(theEntryIndex).addVariableSweep(CreateVariableSweep(theParameterName,'linear', 'Y', [theMinValue,theMaxValue,theNumberOfPoints]));
            end
            
        end
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function activateVariableSweepParameter(obj,theVariableName,theSweepIndex, theSweepSetIndex)
            %activateVariableSweepParameter(theVariableName,theSweepIndex, theSweepSetIndex)
            %Activates a variable sweep parameter
            ...
            %   first variable sweep (v17+)(in the focused sweep set) to true.
            %
            ...
            %   Nth variable sweep (v17+)(in the focused sweep set) to true.
            %   
            %   Project.activateVariableSweepParameter(VariableName,N1, N2) will 
            %   set the parameter in use value for the specified parameter in the
            %   N2th sweep set in the N1th variable sweep to true.
            %
            ...
            if obj.VersionOfSonnet < 17
                ...
                if nargin == 2
                    theSweepIndex = 1;
                elseif nargin == 3
                    theSweepSetIndex = obj.focus();
                end
                obj.getSweepSet(theSweepSetIndex).getVariableSweep(theSweepIndex).enable();
            end
        end
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function deactivateVariableSweepParameter(obj,theVariableName,theSweepIndex, theSweepSetIndex)
            ...
            %   parameter in use value for the specified parameter in the
            %   first variable sweep (v17+)(in the focused sweep set) to false.
            %
            %   Project.deactivateVariableSweepParameter(VariableName,N) will 
            %   set the parameter in use value for the specified parameter in the
            %   Nth variable sweep (v17+)(in the focused sweep set) to false.
            %   
            %   Project.activateVariableSweepParameter(VariableName,N1, N2) will 
            %   set the parameter in use value for the specified parameter in the
            %   N2th sweep set in the N1th variable sweep to false.
            %
            ...
            if obj.VersionOfSonnet < 17
                ...
                obj.getSweepSet(theSweepSetIndex).getVariableSweep(theSweepIndex).disable();
            end
            
        end
        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function changeVariableSweepParameterState(obj,theVariableName,theStatus,theSweepIndex, theSweepSetIndex)
            %changeVariableSweepParameterState   Modify variable sweep parameter status
            %   Project.changeVariableSweepParameterState(VariableName,status) will  
            %   modify the parameter in use value for the specified parameter
            %   in the first variable sweep (v17+)(in the focused sweep set).
            %
            %   Project.changeVariableSweepParameterState(VariableName,status,N) will 
            %   modify the parameter in use value for the specified parameter in 
            %   the Nth variable sweep (v17+)(in the focused sweep set).
            %
            %   Project.activateVariableSweepParameter(VariableName,status,N1,N2) will 
            %   set the parameter in use value for the specified parameter in the
            %   N2th sweep set in the N1th variable sweep to false.
            %
            %   Appropriate status values are 'N','Y','YN','YS', 'YE', (v17+)('YL', 'YC').
            %
            %   See also SonnetProject.activateVariableSweepParameter
            if obj.VersionOfSonnet < 17
                if nargin == 4
                ...
                obj.getSweepSet(theSweepSetIndex).getVariableSweep(theSweepIndex).setOptions(theStatus);
            end
        ...
        function detectAllOptimizationVariables(obj)
            ...
            if obj.VersionOfSonnet < 17
                ...
                error("detectAllOptimizationVariables not implemented for v17+")
            end
        end
        ...
        function addSweepToGoalSet(obj, set, sweep)
            %addSweepToGoalSet(set, sweep) Add a frequency sweep to specified goal set.
            %   1) sweep   - can be created with CreateOptimizationSweep function
            %       CreateFrequencySweep also works, adaptive option will be ignored
            %   2) set     - can be the index of the goal set or the set itself
            %
            %   Example usage:
            %       % create an adaptive frequency sweep from 4.5 to 5.5 GHz
            %       aSweep = CreateOptimizationSweep('ABS', 'Y', 4.5, 5.5)
            %       % add the sweep to set 1 in Project.OptimizationBlock.GoalSets
            %       aSweepIndex = addSweepToGoalSet(1, aSweep)
            %       % retrieve the sweep so it can be edited
            %       aSweep = Project.getSweepFromGoalSet(aSweepIndex, 1)
            if isa(set, 'double')
                obj.OptimizationBlock.GoalSets{set}.addSweep(sweep)
            else
                set.addSweep(sweep)
            end
        end
        ...
        function index = addGoalSet(obj, enabled)
            %addGoalSet(enabled) Add a goal set.
            %   1) goal     - is a SonnetGoal object created either through the
            %   	SonnetGoal constructor or CreateGoal
            %   2) set      - can be the index of the goal set or the goal set itself
            index = obj.OptimizationBlock.addGoalSet(enabled);
        end
        
        function addGoalToGoalSet(obj, goal, set)
            %addGoalToGoalSet(set, goal) Add a goal to specified goal set.
            %   1) goal     - is a SonnetGoal object created either through the
            %   	SonnetGoal constructor or CreateGoal
            %   2) set      - can be the index of the goal set or the goal set itself
            if isa(set, 'double')
                obj.OptimizationBlock.GoalSets{set}.addGoal(goal)
            else
                set.addGoal(sweep)
            end
        end
        
        function sweep = getSweepFromGoalSet(obj, set_index, sweep_index)
            %getSweepFromGoalSet(set_index, sweep_index) Get the frequency
            %sweep with index <sweep_index> from the Goal Set with index <set_index>
            sweep = obj.OptimizationBlock.GoalSets{set_index}.OptimizationSweeps{sweep_index};
        end
        
        function set = getGoalSet(obj, set_index)
            %getGoalSet(set_index) Get the Goal Set with index <set_index>
            set = obj.OptimizationBlock.GoalSets{set_index};
        end
        
        function sweep = getGoalFromGoalSet(obj, set_index, goal_index)
            %getGoalFromGoalSet(set_index, goal_index) Get the optimization goal
            %with index <sweep_index> from the Goal Set with index <set_index>
            sweep = obj.OptimizationBlock.GoalSets{set_index}.OptimizationGoals{goal_index};
        end
        ...
        function addOptimizationParameter(obj,theSweep,theResponseType,...
            ...
            %
            %   Note: Does not work with Sonnet projects v17+, use
            %       addGoalToGoalSet and addSweepToGoalSet
            %
            ...
            if obj.VersionOfSonnet >= 17
                error('addOptimizationParameter does not work with Sonnet Projects v17+, use addGoalToGoalSet and addSweepToGoalSet')
            end
        ...
        function [thePolygon, thePolygonId, theIndex]=findPolygonUsingMeanY(obj,theYCoordinate,theLayer,theSize)
            ...
            %   polygons have a mean y coordinate of 'Y'.
            %
            %   [polygon ID index]=Project.findPolygonUsingMeanY(Y,Layer) finds
            %   polygons have a mean y coordinate of 'Y' on the metallization
            %   layer specified by 'Layer'.
            %
        ...
        function boundingBox = getGeometryBoundingBox(obj)
            %getGeometryBoundingBox returns the bounding box of all
            %   geometry in the project: [x1, y1 ; x2, y2]
            if obj.isGeometryProject
                boundingBox = obj.GeometryBlock.getGeometryBoundingBox();
            else
                error('This method is only available for Geometry projects');
            end
        end
        ...
        function centerGeometry(obj)
            %centerGeometry centers all circuit geometry in the project by
            %   bounding box
            if obj.isGeometryProject
                obj.GeometryBlock.centerGeometry();
            else
                error('This method is only available for Geometry projects');
            end
        end
        ...
        function changeFrequencyUnit(obj,theStringForNewUnit)
            ...
            obj.DimensionBlock.FrequencyUnit=upper(theStringForNewUnit);
        ...
        function changeInductanceUnit(obj,theStringForNewUnit)
            ...
            obj.DimensionBlock.InductanceUnit=upper(theStringForNewUnit);
        end
        ...
        function changeAngleUnit(obj,theStringForNewUnit)
            ...
            obj.DimensionBlock.AngleUnit=upper(theStringForNewUnit);
        end
        ...
        function changeConductivityUnit(obj,theStringForNewUnit)
            ...
            obj.DimensionBlock.ConductivityUnit=upper(theStringForNewUnit);
        end
        ...
        function changeResistanceUnit(obj,theStringForNewUnit)
            ...
            obj.DimensionBlock.ResistanceUnit=upper(theStringForNewUnit);
        end
        ...
        function changeCapacitanceUnit(obj,theStringForNewUnit)
            ...
            obj.DimensionBlock.CapacitanceUnit=upper(theStringForNewUnit);
        end
        ...
        function aReference = addResistorComponent(obj,aComponentName,aResistorValue,...
            ...
            if obj.isGeometryProject
                ...
                error("addResistorComponent is only for geometry projects")
            end
        end
        ...
        function aReference = addCapacitorComponent(obj,aComponentName,aCapacitorValue,...
            ...
            if obj.isGeometryProject
                ...
                error("addCapacitorComponent is only for geometry projects")
            end
        end
        ...
        function aValue = checkIsValid(obj)
            ...
            if obj.VersionOfSonnet < 17 && ~isempty(obj.FrequencyBlock) && ~obj.FrequencyBlock.isValid() 
                %CHANGED : threw error with undefined FrequencyBlock, 
                %isValid cannot be called on nonexistent object
                aValue = false;
            end            
        end
